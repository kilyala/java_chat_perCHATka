...
public class Controller implements Initializable {
                    ...
                    while (true) {
                        ...
                        if (str.startsWith("/")) {
                            if (str.equals(Command.END)) {
                                throw new RuntimeException("Server kicked us");
                            }
                            ...
                            if(str.equals(Command.REG_NON)) {
                                regController.setResultTryToReg(Command.REG_NON);
    ...
    private void setTitle(String nickname) {
        Platform.runLater(()->{
            if(nickname.equals("")){
                stage.setTitle("perCHATka");
            } else {
                stage.setTitle(String.format("perCHATka - [ %s ]", nickname));
            }
        });
    }
    ...
    private void initRegWindow() {
        try {
            ...
            regStage = new Stage();
            regStage.setTitle("perCHATka registration");
